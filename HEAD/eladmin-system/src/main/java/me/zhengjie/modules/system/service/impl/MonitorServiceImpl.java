...
public class MonitorServiceImpl implements MonitorService {
    ...
    private Map<String,Object> getDiskInfo(OperatingSystem os) {
        ...
        for (OSFileStore fs : fsArray){
            // windows 需要將所有磁碟分割槽累加，linux 和 mac 直接累加會出現磁碟重複的問題，待修復
    ...
    private Map<String,Object> getCpuInfo(CentralProcessor processor) {
        ...
        cpuInfo.put("package", processor.getPhysicalPackageCount() + "個物理CPU");
        cpuInfo.put("core", processor.getPhysicalProcessorCount() + "個物理核心");
        cpuInfo.put("coreNumber", processor.getPhysicalProcessorCount());
        cpuInfo.put("logic", processor.getLogicalProcessorCount() + "個邏輯CPU");
        // CPU資訊
