...
import com.ezcore.tools.spreadsheetgen.objects.Web080202Vo;
...
public class Web080202 implements SharedReportService {
    ...
    public Map<String, Object> getDataMapFromServiceImp(String templateName, Map<String, String> params) {
        ...
        List<Web080202Vo> dataList = generateSampleDataList(); // Sample data list
        Map<String, Object> data = new HashMap<>();

        // 3. Add the dataList to the data map
        data.put("year", "2023");
        data.put("dataList", dataList);
        data.put("outputName", "web080202");

        return data;
    }

    // Method to generate sample data list
    private List<Web080202Vo> generateSampleDataList() {
        List<Web080202Vo> dataList = new ArrayList<>();
        dataList.add(new Web080202Vo(100, 50, 50, 50, 80, 30, 50));
